...
def main(argv):
  ...
  class ReplacementScanf(angr.SimProcedure):
    ...
    def run(self, format_string, scanf0_address, scanf1_address):
      ...
      self.state.memory.store(scanf1_address, scanf1, endness=angr.archinfo.arch.Endness.BE)
  ...
  def check_puts(state):
    ...
    # (!)
    puts_parameter_address = state.regs.esp+4
    puts_parameter_length = 4
    puts_parameter = state.memory.load(puts_parameter_address, puts_parameter_length, endness=project.arch.memory_endness)
