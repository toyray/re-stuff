...
def main(argv):
  ...
  # Testing hook at address in case we don't have symbols in the future
  # check_equals_address = 0x80485F5
  # project.hook(check_equals_address, ReplacementCheckEquals())
